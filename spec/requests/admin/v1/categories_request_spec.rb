...
RSpec.describe "Admin::V1::Categories", type: :request do
  ...
  context "DELETE /categories/:id" do
    ...
    it 'remove all product associated' do
    ...
    it 'does not remove unassociated product categories' do
      ...
      delete url, headers: auth_header(user)
      expected_product_categories_ids = product_categories.map(&:id)
      expected_product_categories = ProductCategory.where(id: expected_product_categories_ids)
      expect(expected_product_categories.ids).to contain_exactly(*expected_product_categories_ids)
    end
  end
end
